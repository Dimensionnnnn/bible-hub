...
export function isPending(...actions: AsyncThunk<any, any, any>[]) {
  return (
    action: AnyAction,
  ): action is ReturnType<(typeof actions)[number]['pending']> =>
...
export function isFulfilled(...actions: AsyncThunk<any, any, any>[]) {
  return (
    action: AnyAction,
  ): action is ReturnType<(typeof actions)[number]['fulfilled']> =>
...
export function isRejected(...actions: AsyncThunk<any, any, any>[]) {
  return (
    action: AnyAction,
  ): action is ReturnType<(typeof actions)[number]['rejected']> =>
